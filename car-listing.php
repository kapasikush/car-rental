...
<title>Car Service Portal | Car service Listing</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Car service Listing</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Home</a></li>
        <li>Car service Listing</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> service Listings</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">$<?php echo htmlentities($result->PricePerDay);?> Per Service</p>
            <ul>
...
<?php }} ?>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Recently added service to Cars</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">$<?php echo htmlentities($result->PricePerDay);?> Per Service</p>
                </div>
              </li>
              <?php }} ?>
