...
if($lastInsertId)
{
echo "<script>alert(' Service Booking successfull.');</script>";
}
else 
{
...
<title>Car Service Port | Vehicle service Details</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>$<?php echo htmlentities($result->PricePerDay);?> </p>Per Service
            ...
            <div class="tab-content"> 
              ...
              <div role="tabpanel" class="tab-pane" id="accessories"> 
                ...
                <table>
                  <thead>
                    <tr>
                      <th colspan="2">Services included</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
